...
class sdr_fm_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sdr_fm_radio")
        ...
        self.quad_rate = quad_rate = 500e3
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'rtl_tcp=192.168.0.29:1234'
        )
...
def main(top_block_cls=sdr_fm_radio, options=None):
